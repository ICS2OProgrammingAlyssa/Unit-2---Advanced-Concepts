...
-- sound effects for when you get the question right or wrong
local correctSound
...
local function DetermineAnswers()
    ...
    wrongAnswer3 = answer + math.random(11,18)
end
...
function scene:create( event )
    ...
    addEquationTextObject = display.newText( "", display.contentWidth*1/4, display.contentHeight*4/7, nil, 65 )
    ...
    answerTextObject = display.newText("", display.contentWidth*.4, display.contentHeight*2/3, nil, 60 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.3, display.contentHeight*2/3, nil, 60 )
    wrongAnswer2TextObject = display.newText("", display.contentWidth*.2, display.contentHeight*2/3, nil, 60 )
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.1, display.contentHeight*2/3, nil, 60 )
    ...
    correct = display.newText("Correct", display.contentWidth*1/4, display.contentHeight*2/5, nil, 50 )
    correct:setTextColor(100/255, 47/255, 210/255)
    correct.isVisible = false

    incorrect = display.newText("Incorrect", display.contentWidth*1/4, display.contentHeight*2/5, nil, 50 )
    ...
    bkgMusic = audio.loadSound( "Sounds/level1Music.wav" )

    -- create the correct sound
    correctSound = audio.loadSound( "Sounds/CorrectAnswer.mp3" )

    -- create the incorrect sound
    incorrectSound = audio.loadSound( "Sounds/WrongBuzzer.mp3")
